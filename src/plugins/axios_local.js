...
Axios.interceptors.response.use((response) => {
  ...
  if (!error.response) {
    ...
    Vue.prototype.$notificacao(error.response.data.erro || error.response.data.error || error.response.data.mensagem || 'Erro no servidor, tente novamente mais tarde. Se presistir, contate alguém da equipe!', 'erro', true)
  } else {
    Vue.prototype.$notificacao('Erro ao processar requisição. Tente novamente!', 'erro')
  }
